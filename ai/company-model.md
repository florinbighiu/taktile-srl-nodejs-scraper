...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "TAKTILE") |
| group        | string   | Parent company group (e.g. "Taktile") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/florinbighiu/taktile-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)